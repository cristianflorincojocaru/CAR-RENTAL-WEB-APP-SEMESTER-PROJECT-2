...
- Create Angular project with ng: `ng new car-rental-web-app.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`car-rental-web-app.client.esproj`).
